...
object SupportLibs {
    ...
    const val ANDROIDX_COMPOSE_UI_TOOLING = "androidx.compose.ui:ui-tooling-preview:${Versions.COMPOSE}"
}

object TestingLib {
    const val JUNIT = "junit:junit:${Versions.JUNIT}"
    const val ANDROIDX_COMPOSE_UI_TESTING = "androidx.compose.ui:ui-test-junit4:${Versions.COMPOSE}"
}
